async function scan(browser) {
  ...
  const findings = [];
  try {
    await page.goto('https://news.google.com/search?q=space+infrastructure+lunar+Mars+ISRU+propulsion+space+solar+power+in-space+manufacturing&hl=en', { waitUntil: 'domcontentloaded', timeout: 15000 });
